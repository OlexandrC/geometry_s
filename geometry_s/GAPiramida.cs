...
namespace geometry_s
{
    public class GAPiramida
    {
        ...
        public GAPiramida(GAPoint start_point_, double Radius_, int rib_count_, double height_, bool inside_radius = false, double a1 = 0, double a2 = 0, double a3 = 0)
        {
            ...
            GAPoint top_point_r = GAGeometry.transform_rotate(top_point, start_point_, a1, a2, a3);

            ground = new List<GALine>();

            for (int i = 0; i < rib_count_; i++)
            {
                ribs.Add(new GALine(top_point_r, ground_points[i], i, (int)GAGeometry.word.ребро));
